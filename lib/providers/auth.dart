...
class Auth with ChangeNotifier {
  ...
  Future<void> _authenticate(String email, String password, String urlSegment) async {
    final url = "https://identitytoolkit.googleapis.com/v1/accounts:$urlSegment?key=AIzaSyAfAXNtE7-rRVlj4bAtvykNvPqRMkpopC8";
    try {
  ...
  void _autoLogout() {
    ...
    var timeToExpiration = _expiryDate.difference(DateTime.now()).inSeconds;
